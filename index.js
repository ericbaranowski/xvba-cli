...
const createConfigFile = require('./actions/init.action')
...
program.command('create').description('xvba create [package] - Create Xvba Package scaffold').action((package) => { createPackageScaffold(package) })
...
program.command('init').description('xvba init [package]- Create Xvba Package scaffold').action((package) => { createPackageScaffold(package) })
